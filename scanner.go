...
func (s *Scanner) scanWhitespace() (tok int, pos Pos, lit string) {
...
func (s *Scanner) scanIdent(lookup bool) (tok int, pos Pos, lit string) {
...
func (s *Scanner) ScanRegex() (tok int, pos Pos, lit string) {
	_, pos = s.r.curr()
...
func (s *bufScanner) Scan() (tok int, pos Pos, lit string) {
	return s.scanFunc(s.s.Scan)
}

// ScanRegex reads a regex token from the scanner.
func (s *bufScanner) ScanRegex() (tok int, pos Pos, lit string) {
	return s.scanFunc(s.s.ScanRegex)
}

// scanFunc uses the provided function to scan the next token.
func (s *bufScanner) scanFunc(scan func() (int, Pos, string)) (tok int, pos Pos, lit string) {
...
func (s *bufScanner) curr() (tok int, pos Pos, lit string) {
